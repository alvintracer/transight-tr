...
금융기관은 해외 SaaS나 VASP 내부 Docker 구성요소를 직접 붙이기 어렵습니다. TravelSafer은 국내 IDC ingress와 기존 VAN형 운영 인프라를 통해 Travel Rule 기능을 제공합니다.

## Why It Matters

| Requirement | TravelSafer Response |
|-------------|----------------------|
| 망분리 | 금융기관과 TravelSafer IDC 사이의 승인된 접속 구간 제공 |
| 외부 SaaS 직접통신 제한 | 해외 endpoint 대신 국내 service endpoint 사용 |
