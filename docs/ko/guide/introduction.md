...
TravelSafer은 금융기관과 VASP가 디지털 자산 송수신에 필요한 트래블룰 정보를 안전하게 교환하기 위한 솔루션입니다.

2026년 8월 기준 제품 방향은 명확합니다. TravelSafer은 여러 외부 Travel Rule 네트워크를 모두 직접 adapter로 붙이는 제품이 아니라, TravelSafer가 운영하는 공개키 디렉터리와 암호화 relay를 중심으로 금융기관용 국내 연동 채널을 제공합니다.
...
| Financial Institution Channels | 금융기관은 TravelSafer IDC, 전용성 회선, mTLS, VPN/IPsec, 구간 암호화로 연동할 수 있습니다. |
...
4. TravelSafer이 KYT Gate를 수행합니다.
